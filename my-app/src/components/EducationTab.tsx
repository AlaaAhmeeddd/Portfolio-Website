    ...
    return (
        <>
            <div className="flex flex-col gap-[30px] text-center xl:text-left">
                ...
                <p className='text-white/80 text-sm mx-auto xl:mx-0 leading-loose max-w-[550px]'>{education.description}</p>
            </div>
            <ScrollArea className="h-[400px] mt-10">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-[30px] w-full">
                {
                    ...
                    flex-col justify-center items-center xl:items-start gap-1">
                        ...
                        <p className="font-bold min-h-[60px] max-w-[220px] xl:text-left text-center">{item.position}</p>
